---
layout: post
title:  "Exploring the Colour Lovers API: Getting the Data"
...
In this tutorial, I'll use the [Colour Lovers API](http://www.colourlovers.com/api/) as 
an example. (It turns out an [R package](http://cran.r-project.org/web/packages/colourlovers/index.html) for this API *was* released this August, but I first began exploring it in May.) This
...
Next up: *Exploring the Colour Lovers API: Data Cleaning and Transformation.*